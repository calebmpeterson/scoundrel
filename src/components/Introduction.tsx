...
export const Introduction: FC = () => (
  <div className={styles.container}>
    ...
    <div>
      Scoundrel is a solo rogue-like card game. Each room is made up of four
      cards representing monsters, weapons, and healing items. You must choose
      three cards to resolve in any order and carry the last card to the next
      room.
    </div>
